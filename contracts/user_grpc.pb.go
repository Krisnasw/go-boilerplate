...
func (c *userServiceClient) UpdateFCMToken(ctx context.Context, in *UpdateFCMTokenRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
func (UnimplementedUserServiceServer) UpdateFCMToken(context.Context, *UpdateFCMTokenRequest) (*emptypb.Empty, error) {
